        ...
        <div class="wrap">
            ...
            <div class="secciones">
                <article id="tab1">
                    <div class="row">
                        <div class="col-sm-6">
                            <form action="buscarPersona" method="post" onsubmit="return validarRegistro();">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <form action="" method="post" onsubmit="return validarRegistro();">
                                <div class="form-group">
                                    <label>NIT</label>
                                    <input class="form-control" type="text" placeholder="Digite NIT" onkeypress="return soloNumeros(event)">
                                </div>
                                <div class="form-group">
                                    <button class="btn btn-danger" type="submit">Buscar</button>
                                </div>
