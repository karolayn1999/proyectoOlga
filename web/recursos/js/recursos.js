...
function validarRegistroPersona() {
    ...
    if (doc == "") {
        ...
        return false;
    }else if(tip == "SELECCIONE"){
        alert("ERROR. FALTA SELECCIONAR UN TIPO DE DOCUMENTO");
        return false;
    }else if(nom == ""){
        alert("ERROR. FALTA EL NOMBRE");
        return false;
    }else if(apl == ""){
        alert("ERROR. FALTA EL APELLIDO");
        return false;
    }else if(cor == ""){
        alert("ERROR. FALTA EL CORREO");
        return false;
    }else if(cel == ""){
        alert("ERROR. FALTA EL CELULAR");
        return false;
    } else if (fec == "") {
        alert("ERROR. FALTA LA FECHA DE NACIMIENTO");
        return false;
    } else if (fec.match(regExPattern)) {
        if (patron.test(cor)) {
            return true;
        } else {
            alert("ERROR. CORREO MAL ESCRITO");
            return false;
        }
    } else {
        alert("ERROR. FECHA MAL ESCRITO");
        return false;
    }
}

function validarRegistroEmpresa() {
    var doc=document.getElementById("nit").value;
    var nom=document.getElementById("nombree").value;
    var dir=document.getElementById("dir").value;
    var cel=document.getElementById("tel").value;
    if (doc == "") {
        alert("ERROR. FALTA EL NIT");
        return false;
    }else if(nom == ""){
        alert("ERROR. FALTA EL NOMBRE");
        return false;
    }else if(dir == ""){
        alert("ERROR. FALTA EL DIRECCION");
        return false;
    }else if(cel == ""){
        alert("ERROR. FALTA EL TELEFONO");
        return false;
    }else{
        return true;
    }
...
function validarRegistroTratamiento() {
    var doc=document.getElementById("idt").value;
    var nom=document.getElementById("nomt").value;
    var dir=document.getElementById("dura").value;
    if (doc == "") {
